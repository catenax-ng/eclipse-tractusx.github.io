...
The goal of Catena-X is to empower data-driven use cases to address the current challenges of sustainability,
 ...
 The Industry Core enables a data sovereign data exchange based on parts and vehicles and lays the foundation for compliance with supply chain regulations. 
...
# ![DataChain](assets/DataChain_World.png)

### Mission

The Industry Core describes a component at type and/or instance level, makes it identifiable and discoverable in the network and enables traversing across several levels. 
...
# ![DataChain](assets/IndustryCore.png)
...
Parts and vehicles at type level can be provided at the earliest when the part has been assigned to a supplier. The linking of subcomponents at this point in time is often referred to as BoM as planned. However, the digital representation of the part at type level can also be initiated at a later point in time and remains in place until the part is dismantled.

# ![DataChain](assets/DataChain_OneUp_OneDown.png)
...
The Industry Core enables a data sovereign data exchange based on parts and vehicles and the realization of n-tier data chains. 
...
By reusing the core- & enablement services and the uniform usage of digital twins 
...
To do so, once is enough: Once EDC, BPN, and Decentralized Registry + digital twins according to standardized semantics are established, numerous use cases can be enabled by extending the tech-stack with domain specific data aspects / models.
