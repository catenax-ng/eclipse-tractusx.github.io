...
<span style="font-size:14px;color:rgb(222,140,0);">[Behaviour Twin KIT](../../../overview.md) > [Use-Cases](../../overview.md) > [Health Indicator](../overview.md) > [Development View](overview.md) > Service Bindings</span>
