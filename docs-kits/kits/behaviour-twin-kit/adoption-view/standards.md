...
<span style="font-size:14px;color:rgb(222,140,0);">[Behaviour Twin KIT](../overview) > [Adoption View](./overview) > Standards</span>
...
The following standards are related to the Knwoledge Agent technologies.
They are used within the Behaviour Twin KIT:
...
| Previous | Next |
| -------- | ---- |
| [New Use-Cases](./new-use-cases) | [Guidance And Resources](./guidance-and-resources) |
